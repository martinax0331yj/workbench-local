...
const habits = [
  {
    ...
    templateType: 'literature' as const, frequency: 'daily' as const, targetCount: 1, unit: '篇',
    planTime: '09:00', needNote: false,
    daysActive: ['mon', 'tue', 'wed', 'thu', 'fri', 'sat'],
    linkedGoalIds: ['goal-1'], linkedProjectIds: ['proj-1'], active: true, sortOrder: 0, streak: 12,
    createdAt: '2026-01-01T00:00:00.000Z', updatedAt: iso(now),
  },
  {
    id: 'h-2', title: '论文写作', description: '每日至少写作500字', module: 'paper' as const,
    templateType: 'paper-writing' as const, frequency: 'daily' as const, targetCount: 500, unit: '字',
    planTime: '14:00', needNote: true,
    daysActive: ['mon', 'tue', 'wed', 'thu', 'fri'],
    linkedGoalIds: ['goal-1'], linkedProjectIds: ['proj-1'], active: true, sortOrder: 1, streak: 5,
    createdAt: '2026-01-01T00:00:00.000Z', updatedAt: iso(now),
  },
  {
    id: 'h-3', title: '英语听说练习', description: '每日30分钟英语练习', module: 'learning' as const,
    templateType: 'language' as const, frequency: 'daily' as const, targetCount: 1, unit: '次',
    planTime: '07:00', needNote: false,
    daysActive: ['mon', 'tue', 'wed', 'thu', 'fri', 'sat', 'sun'],
    linkedGoalIds: [], linkedProjectIds: ['proj-4'], active: true, sortOrder: 2, streak: 3,
    createdAt: '2026-01-01T00:00:00.000Z', updatedAt: iso(now),
  },
  {
    id: 'h-4', title: '政策阅读', description: '每周阅读2篇行业政策', module: 'industry' as const,
    templateType: 'policy' as const, frequency: 'weekly' as const, targetCount: 2, unit: '篇',
    planTime: '16:00', needNote: true,
    daysActive: ['mon', 'wed', 'fri'],
    linkedGoalIds: ['goal-4'], linkedProjectIds: ['proj-3'], active: true, sortOrder: 3, streak: 0,
    createdAt: '2026-03-01T00:00:00.000Z', updatedAt: iso(now),
  },
  {
    id: 'h-5', title: '案例整理', description: '每周整理1个行业案例', module: 'industry' as const,
    templateType: 'case' as const, frequency: 'weekly' as const, targetCount: 1, unit: '个',
    planTime: '15:00', needNote: true,
    daysActive: ['tue'],
    linkedGoalIds: ['goal-4'], linkedProjectIds: ['proj-3'], active: true, sortOrder: 4, streak: 0,
    createdAt: '2026-04-01T00:00:00.000Z', updatedAt: iso(now),
  },
  {
    id: 'h-6', title: '体重管理', description: '每日记录饮食与体重', module: 'learning' as const,
    templateType: 'health' as const, frequency: 'daily' as const, targetCount: 1, unit: '次',
    planTime: '08:00', needNote: false,
    daysActive: ['mon', 'tue', 'wed', 'thu', 'fri', 'sat', 'sun'],
    linkedGoalIds: [], linkedProjectIds: [], active: true, sortOrder: 5, streak: 30,
    createdAt: '2026-01-01T00:00:00.000Z', updatedAt: iso(now),
  },
];
